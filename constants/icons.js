...
const icons = {
  ...
  // ═══ 快捷入口专用 ═══
  'pet-add': '<svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="8" r="6" stroke="currentColor" stroke-width="1.5"/><circle cx="7" cy="5" r="1.8" stroke="currentColor" stroke-width="1.5"/><circle cx="12" cy="4" r="1.8" stroke="currentColor" stroke-width="1.5"/><circle cx="17" cy="5" r="1.8" stroke="currentColor" stroke-width="1.5"/><path d="M12 14v6M9 17h6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
  'breeding-new': '<svg viewBox="0 0 24 24" fill="none"><circle cx="9" cy="10" r="4" stroke="currentColor" stroke-width="1.5"/><circle cx="15" cy="10" r="4" stroke="currentColor" stroke-width="1.5"/><path d="M12 14v6M9 17h6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
  'health-shield': '<svg viewBox="0 0 24 24" fill="none"><path d="M4 6c0-1 1-2 2-2h12c1 0 2 1 2 2v5c0 5-3 9-8 11C7 20 4 16 4 11V6z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 8v8M8 12h8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
  'cert-tree': '<svg viewBox="0 0 24 24" fill="none"><path d="M6 2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z" stroke="currentColor" stroke-width="1.5"/><path d="M12 8l-3 6h2l-1 4 5-6h-2l1-4z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="16" cy="17" r="3" fill="currentColor" opacity="0.15"/></svg>',
